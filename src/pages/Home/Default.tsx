      ...
      <IonCard color="light" className="flip-card">
         <IonCardContent className="flip-card-inner">
              <div className="flip-card-front">
                ...
                <br></br>
                <IonRow>
                <p>*Cleaner Needed (Westdene):</p><button style={{backgroundColor:'#013220', color:'dodgerblue'}}><u>APPLY HERE</u></button><br/>
                </IonRow>
                <IonRow>
                <p>*Window Cleaner (Sandton):</p><button style={{backgroundColor:'#013220', color:'dodgerblue'}}><u>APPLY HERE</u></button><br/>
                </IonRow>
                <IonRow>
                <p>*Laundry Services (Randburg):</p><button style={{backgroundColor:'#013220', color:'dodgerblue'}}><u>APPLY HERE</u></button><br/>
                </IonRow>
              </div>
            </IonCardContent>
      </IonCard>
